            ...
            <Menu/>
                ...
                >
                    <div>
                        ...
                        <p style={{marginLeft:'20px',marginBottom:'15px',padding:'5px', color:'#616161'}}>Для перехода на маршрут, сделайте <span style={{color:'#23A6FF'}}> клик </span> по одному из маршрутов</p>
                            <Link onClick={op1} to='' className='popopo' style={{paddingLeft:'20px'}}>
                                <img alt='' src={Aleks}/>
                                ...
                                <Link onClick={op2} to='' className='popopo' style={{paddingLeft:'20px'}}>
                                <img alt='' src={Aleks}/>
                                <div className='sh_t__'>
                                    <h4>Маршрут 1</h4>
                                    <h5>Александров</h5>
                            ...
                            <Link onClick={op3} to='' className='popopo' style={{paddingLeft:'20px'}}>
                                <img alt='' src={Aleks}/>
                                <div className='sh_t__'>
                                    <h4>Маршрут 2</h4>
                                    <h5>Александров</h5>
                            ...
                            <Link onClick={op4} to='' className='popopo' style={{paddingLeft:'20px'}}>
                                <img alt='' src={Aleks}/>
                                <div className='sh_t__'>
                                    <h4>Маршрут 3</h4>
                                    <h5>Александров</h5>
                            ...
                            <Link onClick={op5} to='' className='popopo' style={{paddingLeft:'20px'}}>
                                <img alt='' src={Aleks}/>
                                <div className='sh_t__'>
                                    <h4>Маршрут 4</h4>
                                    <h5>Александров</h5>
