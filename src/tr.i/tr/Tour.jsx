...
function Tour(props) {
    ...
    return (
        <div  className='__tour' onClick={()=>{setRoutOP(props.opr); setVlad(props.title); window.location.href = '/testapp/info-tour' + props.opr}}>
                ...
                <ul>
                    <div>
                        <li>
                            ...
                            <span className='_tr__on_t'>{props.time} ч</span>
                        </li>
                        <li>
